    ...
    def radix_sort(a):
        ...
        if len(a) > 1:
            ...
            for ones in range(10):
                ...
                while current != None:
                    if current._value % 10 == ones:
                        #if current is eligible, adds to bucket
                        buckets[ones].append(a.remove(current._value))
                        #sets new current
                        if prev != None:
                            current = prev._next
                        else:
            ...
            for tens in range(10):
                ...
                while current != None:
                    if (current._value // 10) % 10 == tens:
                        buckets[tens].append(a.remove(current._value))
