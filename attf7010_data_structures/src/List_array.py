...
class List:
    ...
    def _linear_search(self, key):
        ...
        while found == False and i < len(self._values):
    ...
    def clean(self):
        ...
        while i < len(self._values):
            if self._values[i] in cleaner:
                self._values.pop(i)
            else:
                cleaner.append(self._values[i])
                i += 1
    ...
    def combine(self, source1, source2):
        ...
        while source1.is_empty() != False:
            target1.append(source1.pop(0))
           
        while source2.is_empty() != False:
            target2.append(source2.pop(0))

        while target1 != [] or target2 != []:
            if i == 0:
                if target1 != []:
                    self._values.append(target1.pop(0))
                i += 1
            else:
                if target2 != []:
                    self._values.append(target2.pop(0))
                i -= 1
    ...
    def find(self, key):
        ...
        if self._linear_search(key) != -1:
            value = self._values[self._linear_search(key)]
        else:
            value = None
    ...
    def intersection(self, source1, source2):
        ...
        while target1 != []:
            if target1[0] in target2:
                target2.remove(target1[0])
                self._values.append(target1.pop(0))
            else:
                target1.pop(0)
    ...
    def is_identical(self, target):
        ...
        while target.is_empty() != False:
            target_list.append(target.pop(0))
        
        if self._values == [] and target_list == []:
            identical = True
        elif len(self._values) != len(target_list):
            identical = False
        else:
            i = 0
            for i in range(len(self._values)):
                if self._values[i] != target_list[i]:
                    identical = False
    ...
    def remove(self, key):
        ...
        if self._values != [] and self._linear_search(key) != -1:
    ...
    def split(self):
        ...
        while temp != []:
            if i < length // 2:
                target1.append(temp.pop(0))
                i += 1
            else:
                target2.append(temp.pop(0))
    ...
    def union(self, source1, source2):
        ...
        while target != []:
            if target[0] not in self._values:
                self._values.append(target.pop(0))
            else:
                target.pop(0)
